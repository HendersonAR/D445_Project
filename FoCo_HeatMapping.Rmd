...
2.  Use OpenStreetMap and tigris to form a boundary for key areas of Fort Collins
3.  
...
```{r}
start_scoot <- data.frame(read.csv('fort-collins-curb-events-2021-07-26-2024-10-15-trip_starts.csv'))
end_scoot <- data.frame(read.csv('fort-collins-curb-events-2021-07-26-2024-10-15-trip_ends.csv'))
